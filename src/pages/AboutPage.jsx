  ...
  return (
    <div style={{ background: 'var(--cream)', minHeight: '100vh', paddingTop: '80px' }}>
      ...
      <section style={{ background: 'var(--navy)', padding: '100px 40px', textAlign: 'center' }}>
        <p style={{ color: 'var(--gold)', fontStyle: 'italic', fontSize: '14px', letterSpacing: '0.15em', textTransform: 'uppercase', marginBottom: '16px' }}>Our Story</p>
      ...
      <section style={{ maxWidth: '700px', margin: '0 auto', padding: '80px 40px', textAlign: 'center' }}>
        <h2 style={{ color: 'var(--navy)', fontSize: '32px', fontWeight: 700, marginBottom: '24px' }}>Built by travelers, for travelers.</h2>
        <p style={{ color: 'var(--text-mid)', fontSize: '17px', lineHeight: 1.8 }}>
